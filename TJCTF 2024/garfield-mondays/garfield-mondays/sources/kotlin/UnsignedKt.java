...
public final class UnsignedKt {
    ...
    public static final int m498uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m242constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m499uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m242constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m500ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m321constructorimpl(Long.compareUnsigned(v1, v2) >= 0 ? 1L : 0L);
        } else if (v1 >= 0) {
            return ULong.m321constructorimpl(v1 / v2);
        } else {
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            return ULong.m321constructorimpl((Long.compareUnsigned(ULong.m321constructorimpl(rem), ULong.m321constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m501ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            ...
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            if (Long.compareUnsigned(ULong.m321constructorimpl(rem), ULong.m321constructorimpl(v2)) >= 0) {
                j = v2;
            }
    ...
    public static final int doubleToUInt(double v) {
        if (!Double.isNaN(v) && v > uintToDouble(0)) {
            ...
            return v <= 2.147483647E9d ? UInt.m242constructorimpl((int) v) : UInt.m242constructorimpl(UInt.m242constructorimpl((int) (v - Integer.MAX_VALUE)) + UInt.m242constructorimpl(Integer.MAX_VALUE));
        }
        return 0;
    }
