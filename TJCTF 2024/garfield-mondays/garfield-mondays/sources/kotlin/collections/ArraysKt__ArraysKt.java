        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m717contentEqualskV0jMPg(((UByteArray) t).m232unboximpl(), ((UByteArray) t2).m232unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m714contentEqualsFGO6Aew(((UShortArray) t).m495unboximpl(), ((UShortArray) t2).m495unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m715contentEqualsKJPZfPQ(((UIntArray) t).m311unboximpl(), ((UIntArray) t2).m311unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m719contentEqualslec5QzE(((ULongArray) t).m390unboximpl(), ((ULongArray) t2).m390unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m731contentToString2csIQuQ(uByteArray != null ? uByteArray.m232unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m735contentToStringd6D3K8(uShortArray != null ? uShortArray.m495unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m734contentToStringXUkPCBk(uIntArray != null ? uIntArray.m311unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m737contentToStringuLth9ew(uLongArray != null ? uLongArray.m390unboximpl() : null));
            } else {
