...
public final class UStringsKt {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m215unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m478unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m294unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m373unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m294unboximpl = uIntOrNull.m294unboximpl();
            if (Integer.compareUnsigned(m294unboximpl, UInt.m242constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m159boximpl(UByte.m165constructorimpl((byte) m294unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m294unboximpl = uIntOrNull.m294unboximpl();
            if (Integer.compareUnsigned(m294unboximpl, UInt.m242constructorimpl(SupportMenu.USER_MASK)) > 0) {
                return null;
            }
            return UShort.m422boximpl(UShort.m428constructorimpl((short) m294unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m242constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m242constructorimpl(result * uradix);
            result = UInt.m242constructorimpl(UInt.m242constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m236boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        while (i2 < length) {
            ...
            result = ULong.m321constructorimpl(ULong.m321constructorimpl(UInt.m242constructorimpl(digit) & 4294967295L) + result2);
