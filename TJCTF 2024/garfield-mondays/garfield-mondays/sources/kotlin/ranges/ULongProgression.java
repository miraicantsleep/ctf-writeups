...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1367getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }

    /* renamed from: getFirst-s-VKNKU  reason: not valid java name */
    public final long m1391getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1392getLastsVKNKU() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m367toStringimpl(this.first)).append("..").append((Object) ULong.m367toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m367toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m367toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1393fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
