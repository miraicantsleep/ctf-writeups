...
public final class ChannelKt {
    ...
    public static final <T> T m1655getOrElseWpGqRn0(Object $this$getOrElse_u2dWpGqRn0, Function1<? super Throwable, ? extends T> function1) {
        return $this$getOrElse_u2dWpGqRn0 instanceof ChannelResult.Failed ? function1.invoke(ChannelResult.m1663exceptionOrNullimpl($this$getOrElse_u2dWpGqRn0)) : $this$getOrElse_u2dWpGqRn0;
    }

    /* renamed from: onSuccess-WpGqRn0 */
    public static final <T> Object m1658onSuccessWpGqRn0(Object $this$onSuccess_u2dWpGqRn0, Function1<? super T, Unit> function1) {
    ...
    public static final <T> Object m1657onFailureWpGqRn0(Object $this$onFailure_u2dWpGqRn0, Function1<? super Throwable, Unit> function1) {
        if ($this$onFailure_u2dWpGqRn0 instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m1663exceptionOrNullimpl($this$onFailure_u2dWpGqRn0));
        }
        return $this$onFailure_u2dWpGqRn0;
    }

    /* renamed from: onClosed-WpGqRn0 */
    public static final <T> Object m1656onClosedWpGqRn0(Object $this$onClosed_u2dWpGqRn0, Function1<? super Throwable, Unit> function1) {
        if ($this$onClosed_u2dWpGqRn0 instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m1663exceptionOrNullimpl($this$onClosed_u2dWpGqRn0));
        }
