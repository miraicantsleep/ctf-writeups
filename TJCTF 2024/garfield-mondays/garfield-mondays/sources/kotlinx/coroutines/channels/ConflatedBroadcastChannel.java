...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if ((value2 instanceof Closed) && AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(onCloseHandler$FU, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo1654trySendJP2dKIU(E e) {
        Closed it = offerInternal(e);
        if (it != null) {
            return ChannelResult.Companion.m1672closedJP2dKIU(it.getSendException());
        }
