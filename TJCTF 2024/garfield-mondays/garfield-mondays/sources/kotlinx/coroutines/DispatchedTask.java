            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m147constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                    }
                    ...
                    try {
                        ...
                        result = Result.m147constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.Companion;
                        result = Result.m147constructorimpl(ResultKt.createFailure(th));
                        handleFatalException(fatalException, Result.m150exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
