    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo1701scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m1636delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m1637toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1637toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1472compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m1575getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1491getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1L);
        }
        return 0L;
    }
}
